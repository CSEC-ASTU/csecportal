...
export class SendGridEmailService {
  ...
  private constructor() {
    this.apiKey =
      ...
      "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";
    ...
    switch (division.toUpperCase()) {
      ...
      case "COMPETITIVE PROGRAMMING":
        divisionSpecificContent =
          "Lead the competitive programming initiatives and help members excel in problem-solving competitions.";
        break;
      case "DEV":
      case "DEVELOPMENT":
        divisionSpecificContent =
          "Guide the development of innovative software solutions and mentor members in modern development practices.";
        break;
      case "CYBER":
      case "CYBERSECURITY":
        divisionSpecificContent =
          "Oversee cybersecurity training, organize CTF competitions, and build a strong security-focused community.";
        break;
      case "CBD":
      case "CAPACITY BUILDING":
        divisionSpecificContent =
          "Coordinate workshops, training sessions, and skill development programs for all CSEC members.";
        break;
      case "DATA_SCIENCE":
      case "DATA SCIENCE":
        divisionSpecificContent =
          "Lead data science initiatives, organize machine learning projects, and foster a data-driven culture.";
        break;
      default:
        divisionSpecificContent =
          "Lead your division with excellence and help members achieve their full potential.";
    }
  ...
  public async sendDivisionMemberEmail(
    ...
    switch (division.toUpperCase()) {
      ...
      case "COMPETITIVE PROGRAMMING":
        divisionSpecificContent =
          "You'll be part of a team focused on algorithmic problem-solving, competitive programming contests, and developing efficient coding skills.";
        break;
      case "DEV":
      case "DEVELOPMENT":
        divisionSpecificContent =
          "You'll be working on real-world software development projects, learning modern frameworks, and building practical applications.";
        break;
      case "CYBER":
      case "CYBERSECURITY":
        divisionSpecificContent =
          "You'll explore cybersecurity concepts, participate in CTF competitions, and learn about ethical hacking and security practices.";
        break;
      case "CBD":
      case "CAPACITY BUILDING":
        divisionSpecificContent =
          "You'll help organize training sessions, workshops, and skill development programs for all CSEC members.";
        break;
      case "DATA_SCIENCE":
      case "DATA SCIENCE":
        divisionSpecificContent =
          "You'll work with data analysis, machine learning, and AI projects to solve real-world problems using data-driven approaches.";
        break;
      default:
        divisionSpecificContent =
          "You'll be part of an exciting team working on innovative projects and developing valuable skills.";
    }
  ...
  public async sendPasswordResetEmail(
    ...
    }/reset-password?otp=${otp}&email=${encodeURIComponent(email)}`;
